...
class Library:
       ...
       #=====================================================Frames=====================================================
              Main_Frame = Frame(self.root, bg = 'lightblue')
              Main_Frame.grid()

              Title_Frame_1 = Frame(Main_Frame, width = 1350, bg = 'lightblue', relief = RIDGE, bd = 5, padx = 20)
              ...
              Button_Frame = Frame(Main_Frame, width = 1350, height = 50, relief = RIDGE, bd = 5, bg = 'lightblue')
              Button_Frame.pack(side = BOTTOM)

              Detail_Frame = Frame(Main_Frame, width = 1350, height = 100, relief = RIDGE, bd = 5, bg = 'lightblue')
              Detail_Frame.pack(side = BOTTOM)

              Data_Frame = Frame(Main_Frame, width = 1350, height = 400, relief = RIDGE, bd = 5, bg = 'lightblue')
              Data_Frame.pack(side = BOTTOM)

              Frame_1 = LabelFrame(Data_Frame, width = 800, height = 400, relief = RIDGE, bd = 5, bg = 'lightblue', \
                              text = "Library Membership Info:", padx = 20, font = ('arial',15,'bold'))
              Frame_1.pack(side = LEFT, padx = 3)

              Frame_2 = LabelFrame(Data_Frame, width = 550, height = 400, relief = RIDGE, bd = 5, bg = 'lightblue', \
