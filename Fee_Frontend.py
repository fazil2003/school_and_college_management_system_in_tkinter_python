...
class Fee():
    def __init__(self, master):
        ...
        Title_Frame = LabelFrame(
            Main_Frame, width=1350, height=100, bg='lightblue', relief='ridge', bd=5)
        ...
        Data_Frame = Frame(Main_Frame, width=1350, height=350,
                           bg='lightblue', relief='ridge', bd=5)
        Data_Frame.pack(side=TOP, padx=15)

        Frame_1 = LabelFrame(Data_Frame, width=850, height=350, bg='lightblue', relief='ridge', bd=5,
                             text='Informations', font=('arial', 15, 'bold'))
        Frame_1.pack(side=LEFT, padx=10)

        Frame_2 = LabelFrame(Data_Frame, width=495, height=350, bg='lightblue', relief='ridge', bd=5,
        ...
        self.branch_entry = ttk.Combobox(Frame_1, values=(' ', 'DCE', 'DIT', 'DEEE', 'DME', 'DAT', 'DCN', 'DECE'),
        ...
        self.sem_entry = ttk.Combobox(Frame_1, values=(' ', 'FIRST', 'SECOND', 'THIRD', 'FOURTH', 'FIFTH', 'SIXTH',
                                                       'SEVENTH (SW)', 'EIGHTH (SW)'), font=('arial', 14), width=19,
